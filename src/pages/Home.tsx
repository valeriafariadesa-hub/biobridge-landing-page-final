...
const translations = {
  pt: {
    ...
    problem: {
      ...
      connectivityDesc: "A BioBridge funciona mesmo quando as equipes de campo têm acesso limitado ou instável à internet.",
  ...
  en: {
    ...
    hero: {
      ...
      title: "The Bridge\nBetween\nBrazil\nand Europe",
      description: "An offline-first mobile app that empowers small Brazilian producers to prove their products are deforestation-free, unlocking access to the EU market.",
    ...
    problem: {
      ...
      description: "The EU Deforestation Regulation (EUDR) requires digital proof that products like coffee, cocoa, and wood are deforestation-free. Small producers in Brazil lack the technology to comply, risking their livelihoods and cutting them off from the European market.",
      ...
      connectivityDesc: "BioBridge works even when field teams have limited or unreliable internet access.",
